...
<html lang="en" dir="ltr">
  ...
  <div class="col-2 bg-light" id="sidebar">
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      <a class="nav-link active" id="v-pills-home-tab"  href="applyTrip.php" role="tab" aria-controls="" aria-selected="true">Apply for trip</a>
      <a class="nav-link" id="v-pills-profile-tab"  href="viewApplication.php"  aria-controls="" aria-selected="false">My Applications</a>
    </div>
  </div>
    </header>
    <main>
