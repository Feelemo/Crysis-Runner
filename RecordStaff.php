...
<html lang="en" dir="ltr">
  ...
  <div class="col-2 bg-light" id="sidebar">
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      <a class="nav-link" id="v-pills-home-tab"  href="StaffList.php" aria-controls="" aria-selected="false">Staff List</a>
      <a class="nav-link active" id="v-pills-profile-tab"  href="RecordStaff.php" aria-controls="" aria-selected="true">Register Staff</a>
    </div>
  </div>
    </header>
    <main>
      <p class="h4 mb-4">Register CRS Staff</p>
